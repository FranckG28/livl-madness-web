...
export default function Home() {
  return (
    <main className="flex flex-col gap-3 items-center justify-center h-full px-3">
      ...
      <div class="tooltip" data-tip="Bientôt disponible">
        <button class="btn btn-primary gap-2 btn-wide">
          Jouer en ligne
      ...
      <a className="btn btn-secondary gap-2" href="https://github.com/Livl-Corporation/livl-madness/releases">
        Télécharger
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <a className="btn btn-circle btn-ghost absolute top-5 right-5" href="https://dub.sh/livl-madness-repo">
